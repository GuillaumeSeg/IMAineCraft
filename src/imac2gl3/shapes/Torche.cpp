#include <vector>
#include "imac2gl3/shapes/Torche.hpp"
#include "imac2gl3/shapes/common.hpp"

namespace imac2gl3{

	Torche::Torche(GLfloat size){
		m_nVertexCount = 36;
		
		m_pDataPointer = new ShapeVertex[m_nVertexCount];
		
		GLfloat hS = size /2.f;
		GLfloat hS2 = size /16.f;
		...
		m_pDataPointer[1].position.x = hS2; m_pDataPointer[1].position.y = -hS; m_pDataPointer[1].position.z = hS;
		...
		m_pDataPointer[2].position.x = hS2; m_pDataPointer[2].position.y = hS; m_pDataPointer[2].position.z = hS;
		...
		m_pDataPointer[3].position.x = hS2; m_pDataPointer[3].position.y = hS; m_pDataPointer[3].position.z = hS;
		...
		//Face arriere
		m_pDataPointer[6].position.x = -hS; m_pDataPointer[6].position.y = -hS; m_pDataPointer[6].position.z = -hS2;
		...
		m_pDataPointer[7].position.x = hS2; m_pDataPointer[7].position.y = -hS; m_pDataPointer[7].position.z = -hS2;
		...
		m_pDataPointer[8].position.x = hS2; m_pDataPointer[8].position.y = hS; m_pDataPointer[8].position.z = -hS2;
		...
		m_pDataPointer[9].position.x = hS2; m_pDataPointer[9].position.y = hS; m_pDataPointer[9].position.z = -hS2;
		...
		m_pDataPointer[10].position.x = -hS; m_pDataPointer[10].position.y = hS; m_pDataPointer[10].position.z = -hS2;
		...
		m_pDataPointer[11].position.x = -hS; m_pDataPointer[11].position.y = -hS; m_pDataPointer[11].position.z = -hS2;
		...
		//Face droite
		m_pDataPointer[18].position.x = hS2; m_pDataPointer[18].position.y = -hS; m_pDataPointer[18].position.z = -hS2;
		...
		m_pDataPointer[19].position.x = hS2; m_pDataPointer[19].position.y = -hS; m_pDataPointer[19].position.z = hS;
		...
		m_pDataPointer[20].position.x = hS2; m_pDataPointer[20].position.y = hS; m_pDataPointer[20].position.z = hS;
		...
		m_pDataPointer[21].position.x = hS2; m_pDataPointer[21].position.y = hS; m_pDataPointer[21].position.z = hS;
		...
		m_pDataPointer[22].position.x = hS2; m_pDataPointer[22].position.y = hS; m_pDataPointer[22].position.z = -hS2;
		...
		m_pDataPointer[23].position.x = hS2; m_pDataPointer[23].position.y = -hS; m_pDataPointer[23].position.z = -hS2;
		...
		//Face bas
		m_pDataPointer[24].position.x = -hS; m_pDataPointer[24].position.y = -hS; m_pDataPointer[24].position.z = -hS2;
		...
		m_pDataPointer[25].position.x = hS2; m_pDataPointer[25].position.y = -hS; m_pDataPointer[25].position.z = -hS2;
		...
		m_pDataPointer[26].position.x = hS2; m_pDataPointer[26].position.y = -hS; m_pDataPointer[26].position.z = hS;
		...
		m_pDataPointer[27].position.x = hS2; m_pDataPointer[27].position.y = -hS; m_pDataPointer[27].position.z = hS;
		...
		m_pDataPointer[29].position.x = -hS; m_pDataPointer[29].position.y = -hS; m_pDataPointer[29].position.z = -hS2;
		...
		//Face haute
		m_pDataPointer[30].position.x = -hS; m_pDataPointer[30].position.y = hS; m_pDataPointer[30].position.z = -hS2;
		...
		m_pDataPointer[31].position.x = hS2; m_pDataPointer[31].position.y = hS; m_pDataPointer[31].position.z = -hS2;
		...
		m_pDataPointer[32].position.x = hS2; m_pDataPointer[32].position.y = hS; m_pDataPointer[32].position.z = hS;
		...
		m_pDataPointer[33].position.x = hS2; m_pDataPointer[33].position.y = hS; m_pDataPointer[33].position.z = hS;
		...
		m_pDataPointer[35].position.x = -hS; m_pDataPointer[35].position.y = hS; m_pDataPointer[35].position.z = -hS2;
	...
	Torche::~Torche(){ delete[] m_pDataPointer;}
	
	// Renvoit le pointeur vers les données
    const GLvoid* Torche::getDataPointer() const {
        return m_pDataPointer;
    }
    
    // Renvoit le nombre de vertex
    GLsizei Torche::getVertexCount() const {
        return m_nVertexCount;
    }

    // Renvoit la taille du tableau en octets
    GLsizeiptr Torche::getByteSize() const {
